...
class GRU(tf.contrib.rnn.RNNCell):
    ...
    def __init__(
            ...
            recurrent_dropout_keep_prob=0.9
    ):
        ...
        self.recurrent_dropout_keep_prob = recurrent_dropout_keep_prob
    ...
    def call(self, input_, state):
        ...
        if self.use_recurrent_dropout:
            candidate = tf.nn.dropout(candidate,
                                      self.recurrent_dropout_keep_prob)
